...
const exampleEmbed = new discord.MessageEmbed()
	...
	.setAuthor('Checkers In The Park', 'https://i.imgur.com/QswOBNF.png')
	.setThumbnail('https://i.imgur.com/QswOBNF.png')
...
exports.help = {
  name: 'checkers',
   description: "Arkadaşlarınızla oynayabileceğiniz bir Dama oyunudur.",
  usage: '!checkers'  
};