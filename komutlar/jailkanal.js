...
if (!message.member.hasPermission('MANAGE_GUILD')) return message.reply(`**!jailkanal ayarla/sıfırla** isimli komutu kullanabilmek için \`SUNUCUYU YÖNET\` yetkisine sahip olman gerekiyor.`)
if (!args[0]) return message.reply(`Sistemi kullanabilmek için, !jailkanal ayarla/sıfırla @rol yazmalısın.`)
